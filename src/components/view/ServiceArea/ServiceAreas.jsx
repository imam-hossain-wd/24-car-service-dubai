...
//                             >
//                                 <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-primary mb-1" />
//                                 <h3 className="text-xs sm:text-sm font-medium text-gray-800 text-center leading-tight mb-1">
//                                     {area}
//                                 </h3>
//                                 <h4 className="text-xs sm:text-sm font-medium text-gray-800 text-center leading-tight">
//                                     {city} , {country}
//                                 </h4>
