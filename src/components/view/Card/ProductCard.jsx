...
const ProductCard = ({ product }) => {
  return (
    <div className="group relative rounded-xl overflow-hidden transition-all duration-300 ease-in-out shadow-md hover:shadow-lg border border-gray-200 hover:border-primary hover:border-2">
