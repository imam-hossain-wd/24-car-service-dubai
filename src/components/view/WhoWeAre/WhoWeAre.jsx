...
export function WhoWeAre() {
  return (
    <section className="container mx-auto py-5 bg-gradient-to-b from-gray-50 to-white">
      <div className="px-4 mx-auto max-w-7xl">
        <div className="flex flex-col-reverse md:flex-row gap-8 justify-center items-center">
          {/* Content Section */}
          <div className="space-y-4 sm:space-y-6 md:space-x-5">
            {/* Heading */}
            ...
            {/* Mission Statement */}
            <div className="rounded-lg sm:rounded-xl bg-primary/5 p-3 ">
